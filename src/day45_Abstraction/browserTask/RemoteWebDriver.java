...
public class RemoteWebDriver implements WebDriver,TakeScreenShot,JavaScriptExecuter{
    ...
    public RemoteWebDriver(String browserName) {
        if (!(browserName.equalsIgnoreCase("chrome") || browserName.equalsIgnoreCase("opera") ||
                browserName.equalsIgnoreCase("edge") || browserName.equalsIgnoreCase("safari") ||
                browserName.equalsIgnoreCase("firefox")) || browserName.isEmpty() || browserName == null){
