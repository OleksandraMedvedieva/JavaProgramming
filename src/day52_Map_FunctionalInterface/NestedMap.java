...
public class NestedMap {
    public static void main(String[] args) {
        ...
        for (Map.Entry<Map<Integer, String>, Map<String, Integer>> entryMap : mapOfMap.entrySet()) {
            for (Map.Entry<Integer, String> entry : entryMap.getKey().entrySet()) {
        ...
        System.out.println("mapOfMap.get(map1).get(\"Veronica\") = " + mapOfMap.get(map1).get("Veronica"));
        System.out.println("--------------------------------------------");
